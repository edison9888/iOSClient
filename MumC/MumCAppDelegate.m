...
#import "MumCViewController.h"

@implementation MumCAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Override point for customization after application launch.
    self.viewController = [[[MumCViewController alloc] initWithNibName:@"MumCViewController" bundle:nil] autorelease];
